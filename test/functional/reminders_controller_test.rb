...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { description: @reminder.description, name: @reminder.name, ondate: @reminder.ondate }
    end
  ...
  test "should update reminder" do
    put :update, id: @reminder, reminder: { description: @reminder.description, name: @reminder.name, ondate: @reminder.ondate }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
